    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          "data-[side=start]:inset-y-0 data-[side=start]:inset-s-0 data-[side=start]:h-full data-[side=start]:w-3/4 data-[side=start]:border-e data-[side=start]:sm:max-w-sm",
          "data-[side=end]:inset-y-0 data-[side=end]:inset-e-0 data-[side=end]:h-full data-[side=end]:w-3/4 data-[side=end]:border-s data-[side=end]:sm:max-w-sm",
          ...
          "data-[side=start]:data-open:slide-in-from-start-10 data-[side=start]:data-closed:slide-out-to-start-10",
          "data-[side=end]:data-open:slide-in-from-end-10 data-[side=end]:data-closed:slide-out-to-end-10",
          className
        )}
        {...props}
      >
